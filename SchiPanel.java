/* FILENAME: SchiPanel.java
 * AUTHOR: Yuyu Li
 * LAST MODIFIED: 12/18/2014
 * 
 * PURPOSE: Creates a panel that uses a card layout to check through
 * criteria for schizophrenia. Determines whether a patient fits the
 * criteria by using a tree.
 * 
 * */
...
/** *****************************************************************************
  * A SchiPanel class displays a series of panels in a card layout, flipping 
  * through each criteria to check if a patient fits the diagnosis for 
  * schizophrenia.
  * 
  * @author Yuyu Li
  *************************************************************************** **/
public class SchiPanel extends JPanel {
  //instance variables
  ...
  private GenericCriteriaPanel cB, cC, cD, cE, cF;
  ...
  //labels for messages and titles, checkboxes for symptoms, and buttons to reset and exit
  private JLabel jlCritA, jlTitleA, jlYesTitle, jlNoTitle, jlYesMessage, jlNoMessage;
  private JCheckBox jcbA1, jcbA2, jcbA3, jcbA4, jcbA5;
  ...
  /** *****************************************************************************
    * Constructor
    * 
    * Makes a new schizophrenia panel with a card layout that checks through each
    * criteria and determines if the patient can be diagnosed.
    * 
    * @throws FileNotFoundException
    **************************************************************************** **/
  public SchiPanel() throws FileNotFoundException {
    
    try {
      //creating new disorder for schizophrenia and setting instance variables for it
      dis = new Disorder("schizophrenia.txt");
      tree = dis.getTree();
      ...
      cF = new GenericCriteriaPanel(disCriteriaLL, "F");
  ...
  /** *****************************************************************************
    ...
    * criteria panel or reset and start at the beginning.
    * 
    * @author Yuyu Li
    *************************************************************************** **/
